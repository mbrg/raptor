# /raptor-crash-analysis:crash-analysis - Autonomous Crash Root-Cause Analysis
...
```
/raptor-crash-analysis:crash-analysis <bug-tracker-url> <git-repo-url>
```
...
If rr is not installed, display:
```
ERROR: rr debugger is not installed.

Install:
  Linux (Debian/Ubuntu): sudo apt install rr
  From source: https://github.com/rr-debugger/rr

Note: rr requires Linux with perf_event_paranoid <= 1
